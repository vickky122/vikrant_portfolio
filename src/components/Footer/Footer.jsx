  ...
  return (
    <footer className="mt-auto mx-auto container p-4 pt-10 ">
      ...
      <div className="text-center text-gray-300 ">
        ...
        <p className='mt-1 text-base'>Designed & Developed by <a href="https://github.com/vickky122" target='_blank'><span className='text-secondary font-medium'>VikrantKumarYadav</span></a></p>
      </div>
    </footer>
  )
}
